...
public class CLSSLSocketFactory  implements LayeredSocketFactory {
     ...
     */
    private static final CLSSLSocketFactory DEFAULT_FACTORY = new CLSSLSocketFactory();
    
    /**
     * Gets an singleton instance of the SSLProtocolSocketFactory.
     * @return a SSLProtocolSocketFactory
     */
    public static CLSSLSocketFactory getSocketFactory() {
    ...
    public CLSSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public CLSSLSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
     ...
     * @hide
     */
    public CLSSLSocketFactory(javax.net.ssl.SSLSocketFactory socketfactory) {
        super();
    ...
    public CLSSLSocketFactory(String s) throws NoSuchAlgorithmException, KeyManagementException {
    	super();
    	// this.sslcontext = null;
    	// this.socketfactory = HttpsURLConnection.getDefaultSSLSocketFactory();
    	// this.nameResolver = null;
