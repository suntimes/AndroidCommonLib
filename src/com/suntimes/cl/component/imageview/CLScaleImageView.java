 ...
 * 
 */
public class CLScaleImageView extends ImageView {
    ...
    public CLScaleImageView(Context context) {
        super(context);
        init();
    }

    public CLScaleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public CLScaleImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
